...
public class Beach implements Comparable<Beach>
{
    ...
    {
         int distVar = (int) (this.distance - o.getDistance());
         int qualityVar = this.quality -o.getQuality();
        return name.compareTo(o.getName()) + 10*distVar + 100*qualityVar;
    }
    ...
    public static void main(String[] args){
        ...
        TreeSet<Beach> beachSet = new TreeSet<>();
