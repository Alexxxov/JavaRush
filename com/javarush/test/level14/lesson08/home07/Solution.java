...
public class Solution
{
    ...
    {
        for(Apartament aprt: apartaments)
        {
            if(Apt1Room.class.isInstance(aprt))
            {
                Apt1Room aprt1 = (Apt1Room) aprt;
                aprt1.clean1Room();
            }
            else if(Apt2Room.class.isInstance(aprt))
            {
                Apt2Room aprt2 = (Apt2Room) aprt;
                aprt2.clean2Rooms();
            }
             else if(Apt3Room.class.isInstance(aprt))
            {
                Apt3Room aprt3 = (Apt3Room) aprt;
                aprt3.clean3Rooms();
            }
